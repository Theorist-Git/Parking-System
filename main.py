...
conn = mysql.connector.connect(
    host='localhost', database=' parking_system', user='root', password='Sql@2014')
cursor = conn.cursor()
...
def introduction():
    msg = '''
          ...
          Parking is a very big problem in the metro cities, Day by day basis parking system are coming up with new technologoes to 
          solve this issue.  
          ...
          reporting. all these part are further divided into menus for easy navigation
            ...
            Parking Management system made by           : SUHANI CHATURVEDI, SNEHA AGARWAL ,ADITI JAIN
            Class                                       : 12th C             12TH D         12TH D
            School Name                                 : AHLCON PUBLIC SCHOOL
            session                                     : 2021-2022
            
            Thankyou jagdish sir for evaluating my Project.
            \n\n\n
        '''
